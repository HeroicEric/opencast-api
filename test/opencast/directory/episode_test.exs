defmodule Opencast.Directory.EpisodeTest do
  ...
  test "changeset requires published_at" do
    ...
    assert %{published_at: ["can't be blank"]} = errors_on(changeset)
  end
  ...
  test "changeset requires unique link" do
    ...
    assert %{link: ["has already been taken"]} = errors_on(changeset)
  end
end
